...
<head>
  ...
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
   <title>Insert -  Branch Details</title>
...
<section class="content">
			...
			<div id="result" style='display:none' >
				<div class="alert alert-dismissible alert-success">
					<button type="button" class="close" data-dismiss="alert">&times;</button>
						<strong>Data successfully Save..!</strong>
				</div>
			</div>
	...
	<div class="box box-danger">
		<div class="box-header with-border">
			<h3 class="box-title">Fill Information</h3>
		...
		<?php echo form_open('ctrl_master_entry/Branch_entry_insert');?> 
		...
		<div class="box-footer">
			...
			<button type="submit" class="btn btn-danger btn-flat btn-submit" data-toggle="tooltip" data-placement="right" id="submit" name="submit" title="Save" ><i class="glyphicon glyphicon-hand-up"></i>&nbsp;&nbsp;Submit Data</button>
...
$(document).ready(function() {
  $(".btn-submit").click(function(e){
      ...
      $.ajax({
          ...
          dataType: "json",
		  data: {"branch_name": branch_name,"branch_location":branch_location,"branch_number":branch_number},
